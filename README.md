...
- Ensure any code that is platform specific is encased in an #ifdef (platform). Try your best to provide preprocessor macros for both platforms but if you cannot, please mark a TODO comment above or below. All files that include platform specific code should include platform.h and ensure the right macro is defined.
- If you are in the development server, please inform others of what you're currently working on as described in the info. This will help ensure 2 people don't work on the same thing which leads to at least 1 person's work getting reset. Of course, it's okay for more than 1 person to work on a single thing as long as there's a good line of communication.
